  ...
  <aside class="main-sidebar sidebar-light-success elevation-4">
    ...
    <a href="/Dormitory_Director/home" class="brand-link">
      ...
      <div class="user-panel mt-3 pb-1 mb-3 d-flex">
          <h5 class="brand-text font-weight-light ">ผู้อำนวยการกองบริการหอพัก</h5>
        </div>
    <nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
      <li class="nav-header"></li>
                    ...
                    <a class="nav-link" 
                            href="{{ route('logout') }}" 
                                  onclick="event.preventDefault();
                                        ...
                                        ('logout-form').submit();">
                              <i class="nav-icon far"><ion-icon name="log-out-outline"></ion-icon></i>
                              {{ __('ออกจากระบบ') }}
                      </a>
          ...
          <li class="nav-item">
                  <a href="/Director_Dormitory_Service_Division/approveActivity" class="nav-link">
                  <i class="nav-icon far"><ion-icon name="checkmark-circle-outline"></ion-icon></i>
                    <p>
                      อนุมัติกิจกรรม
                    </p>
                  </a>
          ...
          <li class="nav-item">
                  <a href="/Director_Dormitory_Service_Division/showDataActivityAll" class="nav-link">
          ...
          <li class="nav-item">
                  <a href="/Director_Dormitory_Service_Division/showDataStudentAll" class="nav-link">
          ...
          <li class="nav-item">
              <a href="/Director_Dormitory_Service_Division/changePassword" class="nav-link">
