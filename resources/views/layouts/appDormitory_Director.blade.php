  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-orange navbar-light">
      ...
      <ul class="navbar-nav ml-auto">
        <!-- User Name -->
        <li class="nav-item d-none d-sm-inline-block">
          <a class="nav-link" href="/Dormitory_Director/showDataUser">
            {{ Auth::user()->name }}
          </a>
        </li>
      </ul>
    ...
    <aside class="main-sidebar sidebar-light-success elevation-4">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-1 mb-3 d-flex">
          <h5 class="brand-text font-weight-light ">คณะกรรมการหอพัก</h5>
        </div>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="/Dormitory_Director/showDataActivityJoin/{{ Auth::user()->id_users }}" class="nav-link">
                <i class="nav-icon far">
