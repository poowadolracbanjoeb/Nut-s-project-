...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-orange navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="/Head_Information_Unit/home" class="nav-link">หน้าหลัก</a>
        </li>
      </ul>
      ...
      <ul class="navbar-nav ml-auto">
        <!-- User Name -->
        <li class="nav-item d-none d-sm-inline-block">
          <a class="nav-link" href="/Head_Information_Unit/showDataUser">
            {{ Auth::user()->name }}
          </a>
        </li>
      </ul>
    ...
    <aside class="main-sidebar sidebar-light-success elevation-4">
      <!-- Brand Logo -->
      <a href="/Head_Information_Unit/home" class="brand-link">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-1 mb-3 d-flex">
          <h5 class="brand-text font-weight-light ">หัวหน้าฝ่ายเทคโนโลยี</h5>
        </div>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="/Head_Information_Unit/showDataUser" class="nav-link">
                <i class="nav-icon far">
            ...
            <li class="nav-item">
              <a href="/Head_Information_Unit/manageActivityAll" class="nav-link">
                <i class="nav-icon far">
            ...
            <li class="nav-item">
              <a href="/Head_Information_Unit/manageUserAll" class="nav-link">
                <i class="nav-icon far">
            ...
            <li class="nav-item">
              <a href="/Head_Information_Unit/changePassword" class="nav-link">
                <i class="nav-icon far">
