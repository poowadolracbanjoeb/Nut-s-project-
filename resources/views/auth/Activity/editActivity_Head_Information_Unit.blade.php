      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"> <a href="/Head_Information_Unit/manageActivity/editActivityOutline/{{$Activity->activityId}}"> แก้ไขกิจกรรม</a></li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
      ...
      <div class="card-body">
        <form method="POST" enctype="multipart/form-data">
          ...
          รหัสกิจกรรม
            ...
            <br>
            <br>
            <input type="submit" class="btn btn-success" value="บันทึก" formaction="{{url('/Head_Information_Unit/manageActivityAll/editActivity/submit')}}">
        </form>
      </div>
    </div>
  </div>
