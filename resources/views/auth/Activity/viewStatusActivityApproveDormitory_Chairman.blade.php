...
<div class="wrapper">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"><a href="/Dormitory_Chairman/viewStatusActivityApprove">กิจกรรมที่รออนุมัติ</a></li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
  ...
  <div class="row ">
    ...
    <a class="btn btn-warning" href="/Dormitory_Chairman/viewStatusActivityApprove">กิจกรรมที่รออนุมัติ</a>
