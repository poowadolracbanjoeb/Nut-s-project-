      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"><a href="/Dormitory_Chairman/showDataActivityJoin/{{ Auth::user()->id_users }}">กิจกรรมที่เข้าร่วม</a></li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
      ...
      <div class="card-body">
        <table class="table table-striped table-light">
          ...
          <tbody>
            ...
            <td><a class="btn btn-info" href="/Dormitory_Chairman/manageActivity/activityDetail/{{$joinActivity ->activityName}}">ดูรายละเอียด</a>
            </td>
          </tbody>
          @endif
          @endforeach
