...
<section class="content-header">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"><a href="/Head_Dormitory_Service/approveActivity/notApprove/{{$Activity->activityId}}">ดำเนินการไม่อนุมัติกิจกรรม</a></li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
  ...
  <div class="row ">
    ...
    <a class="btn btn-secondary" href="/Head_Dormitory_Service/approveActivity/approve/{{$Activity->activityId}}">ดำเนินการอนุมัติกิจกรรม</a>
    <a class="btn btn-warning" href="/Head_Dormitory_Service/approveActivity/notApprove/{{$Activity->activityId}}">ดำเนินการไม่อนุมัติกิจกรรม</a>
  </div>

<div class="container">
    <div class="card">
        <div class="card-body">
            <form action="/Head_Dormitory_Service/approveActivity/notapprove/submit" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
